<template>
  ...
  <div class="bbb">
    <div class="row text-center">
      <div class="n"><img src="../assets/image/582ab19aN8186b1b4.jpg" alt="" style="margin-left: 20px"></div>
      <div class="n"><img src="../assets/image/aaa.png" alt="" style="margin-left: 20px"></div>
      <div class="ad2">
        <div class="line1"></div>
        <div class="line3">为 您 推 荐</div>
        <div class="line2"></div>
      </div>
    </div>
    <div class="container">
